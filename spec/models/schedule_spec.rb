...
#Test for schedule model

RSpec.describe Schedule, type: :model do
  context "when uploading a schedule" do
    it "creates a new schedule" do
      schedule = Schedule.new(code: "ENGR", course_id: 103, section: 201, lecture_day: "Thursday", start_time: "9:35 AM", end_time: "10:25 AM", professor: "Janute", students: ["test1@email.com", "test2@email.com"])
  ...
  context "when viewing a schedule" do
    it "displays the correct schedule" do
      schedule = Schedule.create(code: "ENGR", course_id: 103, section: 201, lecture_day: "Thursday", start_time: "9:35 AM", end_time: "10:25 AM", professor: "Janute", students: ["test1@email.com", "test2@email.com"])
