...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { course_list: @professor.course_list, course_section: @professor.course_section } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { course_list: @professor.course_list, course_section: @professor.course_section } }
